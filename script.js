...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set wedding date from the HTML data attribute, or fallback to Aug 22, 2026
    const weddingDate = new Date(countdownElement.dataset.date || '2026-08-22T00:00:00').getTime();
